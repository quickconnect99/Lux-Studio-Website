...
> Stack: Next.js 16 · React 19 · Tailwind CSS 3 · Framer Motion 12 · Supabase
...
| `--error-text`      | Theme-aware                 | Error copy on page/panel backgrounds   |
| `--success`         | `#10b981`                   | Success states                         |
| `--success-text`    | Theme-aware                 | Success copy on page/panel backgrounds |
| `--warning`         | `#f59e0b`                   | Warnings, near-limit indicators        |
| `--warning-text`    | Theme-aware                 | Warning copy on page/panel backgrounds |
...
> and easy to theme. Use the `*-text` variants for foreground text on page or
> panel surfaces; retain the base token for fills, borders, and dark overlays.
...
> **Rule:** Display headings use _negative_ tracking (`-0.04em` to `-0.05em`).
> UI elements use _positive_ tracking (`0.20em` to `0.34em`).
